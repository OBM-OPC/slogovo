      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <div className="mt-4 grid items-center gap-8 lg:grid-cols-[1fr_28rem] lg:gap-16">
          <section className="hidden lg:block" aria-label="Slogovo Vorteile">
            <BrandLogo className="[&_svg]:h-12 [&_svg]:w-12 [&_span]:text-3xl" />
          ...
          <div>
            <div className="mb-6 text-center lg:hidden"><BrandLogo className="[&_span]:text-2xl" /><p className="mt-2 text-sm text-muted" lang="bg">Български език</p></div>
            {children}
          </div>
        </div>
      </div>
